...
## Immune laboratory data
### How many mice in the laboratory infections?
...
### Mice n - immune gene expression data 
```{r , message=FALSE, warning=FALSE, echo = FALSE}
GENE_M <- lab %>%
...
For the complete FACS Data set, immune gene expression is complete


# Field infections - experimental planning
...
```
Mice with gene expression data
```{r}
...
## Immune cells
### Laboratory infections - immune cells
...
heatmap_data %>% 
  pheatmap(annotation_col = annotation_df,
           scale = "row")
```
### Correlation between cells laboratory infections
